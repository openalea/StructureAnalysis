 ...
 *
 *       $Source$
 *       $Id: errormsg.h 9869 2010-11-04 17:31:41Z dbarbeau $
 *
...
class VPTOOLS_API ErrorObj {

        /// print an error message.
        friend VPTOOLS_API std::ostream& operator<<(std::ostream&, const ErrorObj&);
...
extern void VPTOOLS_API genMessage(const char* file,
                       int line,
