...
enum {
  ...
  SEQW_NON_HOMOGENEOUS_MARKOV_CHAIN ,
...
enum {
  ...
  SEQL_MARKOV_CHAIN ,
  SEQL_NON_HOMOGENEOUS_MARKOV_CHAIN ,
  ...
  SEQL_NON_HOMOGENEOUS ,
  SEQL_SELF_TRANSITION ,
  SEQL_ASYMPTOTE ,

  SEQL_STATE_NO_OCCURRENCE ,
  SEQL_OUTPUT_NO_OCCURRENCE ,
  SEQL_STATE_FIRST_OCCURRENCE ,
  SEQL_OUTPUT_FIRST_OCCURRENCE ,
  SEQL_LEAVING_STATE ,
  SEQL_LEAVING_OUTPUT ,
  SEQL_STATE_ABSORPTION ,
  SEQL_OUTPUT_ABSORPTION ,
  SEQL_BIASED ,
  SEQL_OCCUPANCY ,
  SEQL_SOJOURN_TIME ,
  SEQL_INITIAL_RUN ,
  ...
  SEQL_STATE_NB_RUN ,
  SEQL_OUTPUT_NB_RUN ,
  SEQL_STATE_NB_OCCURRENCE ,
  SEQL_OUTPUT_NB_OCCURRENCE ,
  SEQL_PER_SEQUENCE ,
  SEQL_PER_LENGTH ,
  SEQL_WORDS ,
...
//  SEQL_GINI_INDEX ,
  ...
  SEQL_VALUE_FIRST_OCCURRENCE ,
  SEQL_VALUE_NB_RUN ,
  SEQL_VALUE_NB_OCCURRENCE ,
  ...
  SEQL_SEGMENT ,
  SEQL_SEGMENTS ,
  SEQL_SEGMENT_MEAN_ABSOLUTE_DIFFERENCE ,
  SEQL_SEGMENT_MEAN_SQUARE_DIFFERENCE ,
  SEQL_NB_SEGMENT ,
...
//  SEQL_NORMALIZED_CHANGE_POINT_ENTROPY ,
  SEQL_SEGMENT_ENTROPY ,
...
enum {
  ...
  SEQR_MIN_ORDER ,
  SEQR_MAX_ORDER ,
  SEQR_INPUT_MARKOV_ORDER ,
  SEQR_NON_HOMOGENEOUS_INPUT_MARKOV ,
  SEQR_WEIGHT_VALUES ,
  SEQR_WEIGHTS_INCOMPATIBLE_WITH_TRANSITIONS ,
  SEQR_NB_PARAMETER ,
  SEQR_OVERLAP ,
  SEQR_MODEL_TYPE ,
  ...
  SEQR_VARIABLE_TYPE ,
  SEQR_VARIABLE_1_TYPE ,
  SEQR_SINGLE_VARIABLE ,
