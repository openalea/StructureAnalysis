...
def test1():
    ...
    seq1 = Sequences(str(get_shared_data("abricotier_suivi_11.seq")))
    ...
    hist2 = ExtractHistogram(TimeEvents(str(get_shared_data("abri13.ren"))), "NbEvent", 16)
    ...
    #########################################################################
    """
    seq11 = Sequences(str(get_shared_data("cafe_ortho1.seq")))
    seq12 = Sequences(str(get_shared_data("cafe_ortho2.seq")))
    seq13 = Sequences(str(get_shared_data("cafe_ortho3.seq")))
    seq14 = Sequences(str(get_shared_data("cafe_ortho4.seq")))
    seq15 = Sequences(str(get_shared_data("cafe_ortho5.seq")))
    seq16 = Sequences(str(get_shared_data("cafe_ortho6.seq")))
