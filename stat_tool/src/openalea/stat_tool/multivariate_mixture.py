...
.. topic:: compound.py summary
    ...
    :Revision: $Id: multivariate_mixture.py 9869 2010-11-04 17:31:41Z dbarbeau $

"""

__version__ = "$Id: multivariate_mixture.py 9869 2010-11-04 17:31:41Z dbarbeau $"
...
def _MultivariateMixture_save(self, file_name, format="ASCII", overwrite=False):
    ...
    if not (format.upper()=="ASCII"
        ...
        except RuntimeError as my_error:
            raise my_error
