...
void _stat_tool_continuous_parametric()
{
        ...
        boost::python::class_< class ::stat_tool::ContinuousParametric, std::shared_ptr< class ::stat_tool::ContinuousParametric > >("ContinuousParametric", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::ContinuousParametric const & >())            .def("copy", method_pointer_51d3f6aaff1c56f9958e931bf18034cc)            .def("ascii_parameter_print", method_pointer_f33e653ce3c45484aaa449282e51e100, boost::python::return_internal_reference<>())            .def("ascii_characteristic_print", method_pointer_094becabde1558ffa4de95bf41b96b5a, boost::python::return_internal_reference<>())            .def("ascii_print", method_pointer_5d741de66ca05becb1d7e36a0888e789, boost::python::return_internal_reference<>())            .def("spreadsheet_parameter_print", method_pointer_13b5f743aa025178a29482819de99c1b, boost::python::return_internal_reference<>())            .def("spreadsheet_print", method_pointer_6479e0bbce00577caf356e5efe797bcb, boost::python::return_internal_reference<>())            .def("spreadsheet_characteristic_print", method_pointer_38e87bcc468751c9b329303b0fd5b1ce, boost::python::return_internal_reference<>())            .def("plot_title_print", method_pointer_838f5b7384dd529d9a3cac3e2e017e66, boost::python::return_internal_reference<>())            .def("plotable_write", method_pointer_e07a6588990458909e46971a75350dae)            .def("nb_parameter_computation", method_pointer_eb05dd7eac87515c9bc1748a0004daa7)            .def("von_mises_mass_computation", method_pointer_2912c7228ded5fe0ad4edc7b170b41fd)            .def("mass_computation", method_pointer_34ac7fb3a6e95c50b999ebc59d6f7bbe)            .def("von_mises_cumul_computation", method_pointer_2753680aa4bf56e888b2b587bf22bfd9)            .def("sup_norm_distance_computation", method_pointer_744741da83c85b21b16946091ba3b49c)            .def("likelihood_computation", method_pointer_2a908d5857785e3ba04ff72f253dd84b)            .def("simulation", method_pointer_b440105ffde95546868447c3762fa258)
