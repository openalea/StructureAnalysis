...
void _stat_tool_single_plot()
{
        ...
        boost::python::class_< class ::stat_tool::SinglePlot, std::shared_ptr< class ::stat_tool::SinglePlot > >("SinglePlot", boost::python::no_init)
            .def(boost::python::init<  >())            .def("add_point", method_pointer_6a7e6a436fdf5223936bab1c87e3a925)            .def("add_point", method_pointer_844b03359db15d14a628d52100fd1a25)            .def("add_text", method_pointer_303fb6128f8e56a9bcbeda47ac209905)            .def("get_x", method_pointer_0284f38ae21d5fbe827f5eab44dce8cb)            .def("get_y", method_pointer_4dac2808834d5d63ad5a8a2212172f8e)            .def("get_label", method_pointer_2f87b39079bc5033b75d79a6ff4ccc2e)            .def("get_size", method_pointer_2ec6352b78ff512f84da5d6d1caed6a9)            .def("size", method_pointer_9bfcc702128d5ec79deb061830e16ef4)            .def("begin", method_pointer_48bd08842095501da93a8d4ef039932e)            .def("end", method_pointer_73c1e2ab42fe5cfda0f730a9dcb393cd)
