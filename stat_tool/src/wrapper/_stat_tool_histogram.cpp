...
void _stat_tool_histogram()
{
        ...
        boost::python::class_< class ::stat_tool::Histogram, std::shared_ptr< class ::stat_tool::Histogram > >("Histogram", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::Histogram const & >())            .def("copy", method_pointer_c75330da123c5028b9eab03621ce51a6)            .def("ascii_print", method_pointer_299e7eadecda52b981d1c38b42254355, boost::python::return_internal_reference<>())            .def("spreadsheet_print", method_pointer_5861a387e27753ca9c5b1bd46211b9d4, boost::python::return_internal_reference<>())            .def("plotable_write", method_pointer_9fdb0ce985a755cfbd7d4382c1b686ab)            .def("max_computation", method_pointer_44692df90a8a558b9f0b9e588c6a1cc9)
