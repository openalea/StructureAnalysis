...
void _stat_tool_curves()
{
        ...
        boost::python::class_< class ::stat_tool::Curves, std::shared_ptr< class ::stat_tool::Curves > >("Curves", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::FrequencyDistribution const & >())            .def("copy", method_pointer_8204b1f9428953b793ca6a11c508e6c0)            .def("smooth", method_pointer_dbd677cf5bd1512fb46974b8e337b517)            .def("remove", method_pointer_d941510568995943b11f44a2dfd1e379)            .def("ascii_print", method_pointer_417a7fa84c2a5b3481b0c74c2a3a3ac2, boost::python::return_internal_reference<>())            .def("spreadsheet_print", method_pointer_62a36ab9413c5462bc87fe06392ee7bc, boost::python::return_internal_reference<>())            .def("plot_length_computation", method_pointer_0e94622c5d265fca996dfce88a750f4c)            .def("plotable_write", method_pointer_60d8c3bcd5b85350996fb9d25c4809f9)            .def("plotable_write", method_pointer_0e6ca46a684b5037acf82119fb1cd1dc)            .def("plotable_frequency_write", method_pointer_b388de4b0d8f56ce825d0ab68adee121)            .def("max_frequency_computation", method_pointer_6d359e59d0cf51fda7730f88e372280a)            .def("nb_element_computation", method_pointer_e94311af09b856d6889b53a1f222abda)            .def("mean_computation", method_pointer_9a007c299165594499a96997b32dda94)            .def("total_square_sum_computation", method_pointer_b8f4f2ed0ffe5884933926b6a43d42fa)
