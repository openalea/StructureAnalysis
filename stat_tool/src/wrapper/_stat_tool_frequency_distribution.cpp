...
void _stat_tool_frequency_distribution()
{
        ...
        class ::stat_tool::DiscreteMixture * (::stat_tool::FrequencyDistribution::*method_pointer_dff399b5b28e5079b5713f52c36fd7d5)(class ::stat_tool::StatError &, class ::stat_tool::DiscreteMixture const &, class ::std::vector<bool, std::allocator<bool> > const &, int, bool, bool, double) const = &::stat_tool::FrequencyDistribution::discrete_mixture_estimation;
        ...
        class ::stat_tool::DiscreteMixture * (::stat_tool::FrequencyDistribution::*method_pointer_5ed04ff8c05f5ed4aaa9169c77aafec8)(class ::stat_tool::StatError &, int, class ::std::vector<stat_tool::discrete_parametric, std::allocator<stat_tool::discrete_parametric> > const &, int, bool, bool, double) const = &::stat_tool::FrequencyDistribution::discrete_mixture_estimation;
        class ::stat_tool::DiscreteMixture * (::stat_tool::FrequencyDistribution::*method_pointer_6797d43f18eb5bbf8ad58f15396d0b09)(class ::stat_tool::StatError &, class ::std::basic_ostream<char, std::char_traits<char> > &, int, int, class ::std::vector<stat_tool::discrete_parametric, std::allocator<stat_tool::discrete_parametric> > const &, int, bool, bool, enum ::stat_tool::model_selection_criterion, double) const = &::stat_tool::FrequencyDistribution::discrete_mixture_estimation;
        ...
        boost::python::class_< class ::stat_tool::FrequencyDistribution, std::shared_ptr< class ::stat_tool::FrequencyDistribution >, boost::python::bases< class ::stat_tool::Reestimation<int> > >("FrequencyDistribution", boost::python::no_init)
            ...
            .def("discrete_mixture_estimation", method_pointer_dff399b5b28e5079b5713f52c36fd7d5, boost::python::return_value_policy< boost::python::reference_existing_object >())
            ...
            .def("discrete_mixture_estimation", method_pointer_5ed04ff8c05f5ed4aaa9169c77aafec8, boost::python::return_value_policy< boost::python::reference_existing_object >())
            .def("discrete_mixture_estimation", method_pointer_6797d43f18eb5bbf8ad58f15396d0b09, boost::python::return_value_policy< boost::python::reference_existing_object >())
