...
void _stat_tool_discrete_mixture_data()
{
        ...
        class ::std::basic_ostream<char, std::char_traits<char> > & (::stat_tool::DiscreteMixtureData::*method_pointer_278e115facfc5fcdb0ed841028916a29)(class ::std::basic_ostream<char, std::char_traits<char> > &) const = &::stat_tool::DiscreteMixtureData::line_write;
        class ::std::basic_ostream<char, std::char_traits<char> > & (::stat_tool::DiscreteMixtureData::*method_pointer_6568980242ba57f896ece1ac19e17be3)(class ::std::basic_ostream<char, std::char_traits<char> > &, bool) const = &::stat_tool::DiscreteMixtureData::ascii_write;
        class ::stat_tool::MultiPlotSet * (::stat_tool::DiscreteMixtureData::*method_pointer_2606379fda6757629e26d746dcbe68a3)() const = &::stat_tool::DiscreteMixtureData::get_plotable;
