...
void _stat_tool_discrete_parametric_process()
{
        ...
        boost::python::class_< class ::stat_tool::DiscreteParametricProcess, std::shared_ptr< class ::stat_tool::DiscreteParametricProcess > >("DiscreteParametricProcess", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::DiscreteParametricProcess const & >())            .def("copy", method_pointer_0659c17596ec518882570be258267c93)            .def("remove", method_pointer_850a40312e435b39ad131196d1a87f09)            .def("nb_value_computation", method_pointer_1f5be9cbc73c53a5ad2264314197ec16)            .def("nb_parameter_computation", method_pointer_bf5091e7332b5c1f80763c568d769400)            .def("mean_computation", method_pointer_464f8d86b1d95924b46b13dd966b6773)            .def("variance_computation", method_pointer_2fd07342c4735ca5ae18a3164e60c237)            .def("mixture_computation", method_pointer_0a3b99321bbe5f59907fd46f2775d1c3, boost::python::return_value_policy< boost::python::reference_existing_object >())            .def("init", method_pointer_ef05876447e35b788dd014ff886c147b)
