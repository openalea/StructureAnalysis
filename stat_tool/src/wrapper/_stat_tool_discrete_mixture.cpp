...
void _stat_tool_discrete_mixture()
{
        ...
        boost::python::class_< class ::stat_tool::DiscreteMixture, std::shared_ptr< class ::stat_tool::DiscreteMixture >, boost::python::bases< class ::stat_tool::StatInterface, class ::stat_tool::Distribution > >("DiscreteMixture", boost::python::no_init)
            ...
            .def("get_mixture_data", method_pointer_7d90346215f9587694ba87c1d315be33, boost::python::return_value_policy< boost::python::reference_existing_object >())
            .def("get_nb_component", method_pointer_ec26191b00235d48be2d6b293afbe914)
            .def("get_weight", method_pointer_3b21e929cddc54d08e2c0d4e46dcc2d9, boost::python::return_value_policy< boost::python::reference_existing_object >())
            .def("get_component", method_pointer_348c66d6dde35bc08b6f5e06a873d4d1, boost::python::return_value_policy< boost::python::reference_existing_object >());
