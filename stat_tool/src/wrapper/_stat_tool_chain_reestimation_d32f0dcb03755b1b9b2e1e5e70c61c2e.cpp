...
void _stat_tool_chain_reestimation_d32f0dcb03755b1b9b2e1e5e70c61c2e()
{
        ...
        boost::python::class_< class ::stat_tool::ChainReestimation<int>, std::shared_ptr< class ::stat_tool::ChainReestimation<int> > >("_ChainReestimation_d32f0dcb03755b1b9b2e1e5e70c61c2e", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::ChainReestimation<int> const & >())            .def("init", method_pointer_6075593975375673a3b0c7e3b22cff24)            .def("copy", method_pointer_8747980cd3bd5a45ac85c9a3644bd0ef)            .def("remove", method_pointer_c27152443a63579581036b6f2788d6c6)            .def("print", method_pointer_c86942b6943e5e4489c08e90caa4d02e, boost::python::return_internal_reference<>())
