...
void _stat_tool_continuous_parametric_process()
{
        ...
        boost::python::class_< class ::stat_tool::ContinuousParametricProcess, std::shared_ptr< class ::stat_tool::ContinuousParametricProcess > >("ContinuousParametricProcess", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::ContinuousParametricProcess const & >())            .def("copy", method_pointer_a51fa7e43cd559d48e6193d1985ac289)            .def("remove", method_pointer_c0ed3022bc4c5e1ba45f2928b3b5af9b)            .def("nb_parameter_computation", method_pointer_d474df83ba195ee181fd24c1a5b56fc2)            .def("mean_computation", method_pointer_0a554efc0f6c5d83a995f8fbf54cad2d)            .def("variance_computation", method_pointer_cebc3dc50e265dddb861748541b68e5b)            .def("select_unit", method_pointer_e4038a834f085556ba7622988e069150)            .def("init", method_pointer_f1e34b3cae8354bf88b0b69db8db7c67)            .def("interval_computation", method_pointer_ca47b5e35f5153f0ae9795874e4324e4, boost::python::return_internal_reference<>())
