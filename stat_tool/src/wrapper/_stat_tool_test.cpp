...
void _stat_tool_test()
{
        ...
        boost::python::class_< class ::stat_tool::Test, std::shared_ptr< class ::stat_tool::Test > >("Test", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::Test const & >())            .def("copy", method_pointer_5d1e82f49af15250bdfc9ed3c007426f)            .def("ascii_print", method_pointer_4da67ea9bb6f59dc8ce44b976fb440ff, boost::python::return_internal_reference<>())            .def("spreadsheet_print", method_pointer_2e7f62768c54586baba69036ba2b6ff4, boost::python::return_internal_reference<>())            .def("standard_normal_critical_probability_computation", method_pointer_fe1275e4546a5da09641c670d5b6177d)            .def("standard_normal_value_computation", method_pointer_1828d9c2d2415ae68b778f6d26c05036)            .def("chi2_critical_probability_computation", method_pointer_a2f30cdc9f8656f6a5b9b12990f0187c)            .def("chi2_value_computation", method_pointer_e2b31f57c62459d2b55949f85f609ab5)            .def("f__critical_probability_computation", method_pointer_0496cfc256345921a65582f307882888)            .def("f__value_computation", method_pointer_395c5b3a9b045414a12c16407e5beb09)            .def("t_critical_probability_computation", method_pointer_56006b70c92b5107b03c64bf8d3a993a)            .def("t_value_computation", method_pointer_6dc9bf3a118e5863904b7e8efab67296)
