...
void _stat_tool_chain()
{
        ...
        boost::python::class_< class ::stat_tool::Chain, std::shared_ptr< class ::stat_tool::Chain > >("Chain", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::Chain const & >())            .def("parameter_copy", method_pointer_a255fb643996510ca503e0599fd445c5)            .def("copy", method_pointer_3e1e9bbe45495cac8fe305ca8064a73d)            .def("remove", method_pointer_06eebefd01815b2cbf83a87c5b7f4349)            .def("ascii_print", method_pointer_f7574889cdbb5fd381197d07f04e7af0, boost::python::return_internal_reference<>())            .def("spreadsheet_print", method_pointer_cac61d75eba05a709779f52328e898f9, boost::python::return_internal_reference<>())            .def("create_cumul", method_pointer_a7a1ab89213756b282b6ca868005bb8b)            .def("cumul_computation", method_pointer_4d2ce28bf1025608a64163e69ce7beb3)            .def("remove_cumul", method_pointer_e4b964206af254b7aa6dc1c1df876b0e)            .def("log_computation", method_pointer_479008557ee351fa94dd837219f04e24)            .def("probability_accessibility_computation", method_pointer_a6a8144bc965575cb12cb1bcd1b31328)            .def("thresholding", method_pointer_a1c3a26e57da572fbbe0a5fdf925e646)            .def("nb_parameter_computation", method_pointer_169d063bc4985ff49208c4e648dc7b11)            .def("chi2_value_computation", method_pointer_31c042fd128258f39ed5c70ff948be31)            .def("init", method_pointer_ad88b036fac55065aae22812dc3a4b4e)            .def("likelihood_computation", method_pointer_e303c8fae3345709a2ee6b3a84cd16d5)            .def("chi2_fit", method_pointer_895ffb83a01d57c99eeb11a71fef736d)
