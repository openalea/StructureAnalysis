...
void _stat_tool_discrete_parametric_model()
{
        ...
        boost::python::class_< class ::stat_tool::DiscreteParametricModel, std::shared_ptr< class ::stat_tool::DiscreteParametricModel >, boost::python::bases< class ::stat_tool::StatInterface, class ::stat_tool::DiscreteParametric > >("DiscreteParametricModel", boost::python::no_init)
            ...
            .def("line_write", method_pointer_3152ba8f25f15da4ae88c5ddd18fa208, boost::python::return_internal_reference<>())
            .def("ascii_write", method_pointer_38a9d5f013ef572d9949f81bfa7614e2, boost::python::return_internal_reference<>())
            .def("get_plotable", method_pointer_4b4e68f0e11859bbb8062f0a5b9c3f41, boost::python::return_value_policy< boost::python::reference_existing_object >())
