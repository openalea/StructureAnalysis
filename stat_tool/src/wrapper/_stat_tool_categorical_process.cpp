...
void _stat_tool_categorical_process()
{
        ...
        boost::python::class_< class ::stat_tool::CategoricalProcess, std::shared_ptr< class ::stat_tool::CategoricalProcess > >("CategoricalProcess", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::CategoricalProcess const & >())
            .def("copy", method_pointer_9f738e654a3153949fb7de2b20354bad)
            .def("remove", method_pointer_3ad9bf8558705dc4a1d8455af57c9823)
            .def("test_hidden", method_pointer_23690c6039895e51b89862cc91bda6ef)
            .def("thresholding", method_pointer_a1a2ac36602f5025be1030997df0ef30)
            .def("nb_parameter_computation", method_pointer_8951048518bd56cdb8bea63a4171760a)
            .def("mixture_computation", method_pointer_69fc5792cee357a68e2fe90f027996ac, boost::python::return_value_policy< boost::python::reference_existing_object >())
            .def("init", method_pointer_907f57d2b6675b84b5584f60a77b5fcb)
