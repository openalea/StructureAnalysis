...
void _stat_tool_stat_interface()
{
        ...
        boost::python::class_< class ::stat_tool::StatInterface, std::shared_ptr< class ::stat_tool::StatInterface >, boost::noncopyable >("StatInterface", boost::python::no_init)
            .def("line_write", method_pointer_3142c767cdb557b1a7f57cb7cdcb0d1d, boost::python::return_internal_reference<>())
            .def("ascii_write", method_pointer_46dda22d835a5df7afe6ca38c125d95d, boost::python::return_internal_reference<>())
            .def("get_plotable", method_pointer_dcd5f5dbeaed52b1a46267335ba3f07b, boost::python::return_value_policy< boost::python::reference_existing_object >());
}