...
public:
  ...
  static Clusters* partitioning_clusters(
  ...
  static std::string hierarchical_clustering(
		  const Distance_matrix& dm,
  ...
  static Distance_matrix* select_individual(const Distance_matrix& v,
  ...
  static double get_length(Distance_matrix &input, int i, int j)
  {
	  double ret;
	  ...
	  ostringstream error_message;
	  error_message << "index not in range of validity" <<endl;\
...
void class_distance_matrix()
{
  ...
  class_< Distance_matrix, bases< STAT_interface > >
    ...
    .def("get_distance", &CLASS::get_distance,
    ...
    .def("hierarchical_clustering",	WRAP::hierarchical_clustering,
    		ARGS("algorithm","criterion","path","format"),
