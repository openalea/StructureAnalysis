...
void _stat_tool_mixture()
{
        ...
        boost::python::class_< class ::stat_tool::Mixture, std::shared_ptr< class ::stat_tool::Mixture >, boost::python::bases< class ::stat_tool::StatInterface > >("Mixture", boost::python::no_init)
            ...
            .def("line_write", method_pointer_1310994dccbc55598c8ba46850200450, boost::python::return_internal_reference<>())
            .def("ascii_write", method_pointer_6f3143b7ff625bc5824145e88a1718e8, boost::python::return_internal_reference<>())
            .def("get_plotable", method_pointer_afe34d7df78e5e569be68e6089b7c066, boost::python::return_value_policy< boost::python::reference_existing_object >())
