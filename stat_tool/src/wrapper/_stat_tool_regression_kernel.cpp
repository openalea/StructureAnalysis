...
void _stat_tool_regression_kernel()
{
        ...
        boost::python::class_< class ::stat_tool::RegressionKernel, std::shared_ptr< class ::stat_tool::RegressionKernel > >("RegressionKernel", boost::python::no_init)
            ...
            .def(boost::python::init< class ::stat_tool::RegressionKernel const & >())            .def("copy", method_pointer_b9f6269292575bc5927fad1a476f13df)            .def("remove", method_pointer_7e6ebd55b9275f0fb16ac80ccec42546)            .def("ascii_parameter_print", method_pointer_38793ad727d75fd99ae45c0bab92cb45, boost::python::return_internal_reference<>())            .def("ascii_formal_print", method_pointer_e622661965515b658a029be2f8dacc2b, boost::python::return_internal_reference<>())            .def("ascii_print", method_pointer_73826b86625f5048b5e6daf11a737321, boost::python::return_internal_reference<>())            .def("spreadsheet_print", method_pointer_4f733e68331455deb67c59b49e50f996, boost::python::return_internal_reference<>())            .def("plotable_write", method_pointer_c522407fe3b85da5a427c7119f1d1aa0)            .def("computation", method_pointer_386cc5e062f15a5d84da5c522d8c71b9)            .def("min_computation", method_pointer_f5f8fb700b86503b877dbdf9e84fe7de)            .def("max_computation", method_pointer_1ff834e792c7558989512355ed6e11cb)
