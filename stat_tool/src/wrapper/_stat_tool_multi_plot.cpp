...
void _stat_tool_multi_plot()
{
        ...
        class ::__gnu_cxx::__normal_iterator<const stat_tool::SinglePlot *, std::vector<stat_tool::SinglePlot, std::allocator<stat_tool::SinglePlot> > > (::stat_tool::MultiPlot::*method_pointer_5424772420bf5a34b0b0a72fe30ec7a2)() = &::stat_tool::MultiPlot::begin;
        class ::__gnu_cxx::__normal_iterator<const stat_tool::SinglePlot *, std::vector<stat_tool::SinglePlot, std::allocator<stat_tool::SinglePlot> > > (::stat_tool::MultiPlot::*method_pointer_d319b100173f53639a285a96deac04ea)() = &::stat_tool::MultiPlot::end;
        boost::python::class_< class ::stat_tool::MultiPlot, std::shared_ptr< class ::stat_tool::MultiPlot > >("MultiPlot", boost::python::no_init)
            .def(boost::python::init< int >())            .def("__setitem__", method_pointer_af406258214b5e0d8168d234bb932acb, boost::python::return_internal_reference<>())            .def("resize", method_pointer_95aa6653df98514e8e5b7e3f8fbf1b4b)            .def("size", method_pointer_eab7c2749bae5da3903dfe580bd77831)            .def("begin", method_pointer_5424772420bf5a34b0b0a72fe30ec7a2)            .def("end", method_pointer_d319b100173f53639a285a96deac04ea)
