...
void wrapper_795c302c81665a5e9b66593bb34d8618()
{
    ...
    class ::stat_tool::Convolution * (*method_pointer_d3f447f87f1954328f135e6fafbc82f7)(class ::stat_tool::StatError &, int , class ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > > const) = ::stat_tool::Convolution::building;
    class ::stat_tool::Convolution * (*method_pointer_186d37a935b5535ba8658ef58c6f8532)(class ::stat_tool::StatError &, class ::std::basic_string< char, struct ::std::char_traits< char >, class ::std::allocator< char > > const, double ) = ::stat_tool::Convolution::ascii_read;
    ...
    class_795c302c81665a5e9b66593bb34d8618.def("building", method_pointer_d3f447f87f1954328f135e6fafbc82f7, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
    class_795c302c81665a5e9b66593bb34d8618.def("ascii_read", method_pointer_186d37a935b5535ba8658ef58c6f8532, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
    ...
    class_795c302c81665a5e9b66593bb34d8618.staticmethod("building");
    ...
    if(autowig::Held< class ::stat_tool::Convolution >::is_class)
    {
        ...
        //boost::python::objects::class_value_wrapper< autowig::Held< class ::stat_tool::Convolution >::Type, boost::python::objects::make_ptr_instance< class ::stat_tool::Convolution, boost::python::objects::pointer_holder< autowig::Held< class ::stat_tool::Convolution >::Type, class ::stat_tool::Convolution > > >();
    }
