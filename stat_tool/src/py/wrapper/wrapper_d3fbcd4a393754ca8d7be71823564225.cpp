...
void wrapper_d3fbcd4a393754ca8d7be71823564225()
{
    ...
    void  (::std::vector< enum ::stat_tool::discrete_parametric, ::std::allocator< enum ::stat_tool::discrete_parametric > >::*method_pointer_919476ddf078560eaa8f099950d2fe22)(class ::std::move_iterator< class ::__gnu_cxx::__normal_iterator< enum ::stat_tool::discrete_parametric *, class ::std::vector< enum ::stat_tool::discrete_parametric, class ::std::allocator< enum ::stat_tool::discrete_parametric > > > > , class ::std::move_iterator< class ::__gnu_cxx::__normal_iterator< enum ::stat_tool::discrete_parametric *, class ::std::vector< enum ::stat_tool::discrete_parametric, class ::std::allocator< enum ::stat_tool::discrete_parametric > > > > ) = &::std::vector< enum ::stat_tool::discrete_parametric, class ::std::allocator< enum ::stat_tool::discrete_parametric > >::assign;
    ...
    class_d3fbcd4a393754ca8d7be71823564225.def(boost::python::init< class ::std::move_iterator< class ::__gnu_cxx::__normal_iterator< enum ::stat_tool::discrete_parametric *, class ::std::vector< enum ::stat_tool::discrete_parametric, class ::std::allocator< enum ::stat_tool::discrete_parametric > > > > , class ::std::move_iterator< class ::__gnu_cxx::__normal_iterator< enum ::stat_tool::discrete_parametric *, class ::std::vector< enum ::stat_tool::discrete_parametric, class ::std::allocator< enum ::stat_tool::discrete_parametric > > > > , ::std::vector< enum ::stat_tool::discrete_parametric, class ::std::allocator< enum ::stat_tool::discrete_parametric > >::allocator_type const & >(""));
    ...
    class_d3fbcd4a393754ca8d7be71823564225.def("assign", method_pointer_919476ddf078560eaa8f099950d2fe22, "");
