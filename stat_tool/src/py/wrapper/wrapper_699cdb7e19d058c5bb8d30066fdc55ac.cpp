...
void wrapper_699cdb7e19d058c5bb8d30066fdc55ac()
{
    ...
    class ::stat_tool::DiscreteDistributionData * (*method_pointer_fd580e2bf7c7555bb687b470aa77a262)(class ::stat_tool::StatError &, class ::std::basic_string< char, struct ::std::char_traits< char >, class ::std::allocator< char > > const) = ::stat_tool::DiscreteDistributionData::ascii_read;
    ...
    class_699cdb7e19d058c5bb8d30066fdc55ac.def("ascii_read", method_pointer_fd580e2bf7c7555bb687b470aa77a262, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
