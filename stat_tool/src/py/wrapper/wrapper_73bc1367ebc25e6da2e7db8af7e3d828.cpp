...
void wrapper_73bc1367ebc25e6da2e7db8af7e3d828()
{
    ...
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Histogram::*method_pointer_299e7eadecda52b981d1c38b42254355)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool ) const = &::stat_tool::Histogram::ascii_print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Histogram::*method_pointer_5861a387e27753ca9c5b1bd46211b9d4)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &) const = &::stat_tool::Histogram::spreadsheet_print;
    ...
    class_73bc1367ebc25e6da2e7db8af7e3d828.def("ascii_print", method_pointer_299e7eadecda52b981d1c38b42254355, boost::python::return_internal_reference<>(), "");
    class_73bc1367ebc25e6da2e7db8af7e3d828.def("spreadsheet_print", method_pointer_5861a387e27753ca9c5b1bd46211b9d4, boost::python::return_internal_reference<>(), "");
