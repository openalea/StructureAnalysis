...
void wrapper_42d9fc9d560e519a8cee703c630b1d4b()
{
    ...
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Curves::*method_pointer_417a7fa84c2a5b3481b0c74c2a3a3ac2)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool , class ::stat_tool::Curves const *) const = &::stat_tool::Curves::ascii_print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Curves::*method_pointer_62a36ab9413c5462bc87fe06392ee7bc)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, class ::stat_tool::Curves const *) const = &::stat_tool::Curves::spreadsheet_print;
    ...
    class_42d9fc9d560e519a8cee703c630b1d4b.def("ascii_print", method_pointer_417a7fa84c2a5b3481b0c74c2a3a3ac2, boost::python::return_internal_reference<>(), "");
    class_42d9fc9d560e519a8cee703c630b1d4b.def("spreadsheet_print", method_pointer_62a36ab9413c5462bc87fe06392ee7bc, boost::python::return_internal_reference<>(), "");
