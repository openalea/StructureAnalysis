...
namespace autowig
{
    ...
    void method_decorator_b2dc7c9864fc5229847fac6a174f3f0d(class ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > > & instance, ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > >::size_type  param_in_0, ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > >::reference  param_out)     { instance.operator[](param_in_0) = param_out; }
    void method_decorator_d6099c3104af5a46bbaddcfe1bee30f1(class ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > > & instance, ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > >::size_type  param_in_0, ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > >::reference  param_out)     { instance.at(param_in_0) = param_out; }
    void method_decorator_4c47ded6a4d75c618d527e5817501594(class ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > > & instance, ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > >::reference  param_out)     { instance.front() = param_out; }
    void method_decorator_45c9d8576617591193097d21f86d935c(class ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > > & instance, ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > >::reference  param_out)     { instance.back() = param_out; }
}
