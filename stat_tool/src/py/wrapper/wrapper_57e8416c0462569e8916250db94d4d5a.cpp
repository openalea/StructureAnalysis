...
void wrapper_57e8416c0462569e8916250db94d4d5a()
{
    ...
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::StatInterface::*method_pointer_3142c767cdb557b1a7f57cb7cdcb0d1d)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &) const = &::stat_tool::StatInterface::line_write;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::StatInterface::*method_pointer_46dda22d835a5df7afe6ca38c125d95d)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool ) const = &::stat_tool::StatInterface::ascii_write;
    ...
    class_57e8416c0462569e8916250db94d4d5a.def("line_write", boost::python::pure_virtual(method_pointer_3142c767cdb557b1a7f57cb7cdcb0d1d), boost::python::return_internal_reference<>(), "");
    class_57e8416c0462569e8916250db94d4d5a.def("ascii_write", boost::python::pure_virtual(method_pointer_46dda22d835a5df7afe6ca38c125d95d), boost::python::return_internal_reference<>(), "");
