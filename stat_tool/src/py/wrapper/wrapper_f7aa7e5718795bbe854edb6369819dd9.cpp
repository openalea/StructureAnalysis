...
void wrapper_f7aa7e5718795bbe854edb6369819dd9()
{
    ...
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::FrequencyDistribution::*method_pointer_fe56e7a238fd57bab9b0d879dad60138)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, int , bool ) const = &::stat_tool::FrequencyDistribution::ascii_print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::FrequencyDistribution::*method_pointer_47742b5d162a572196d7afae32ba3de5)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool , bool ) const = &::stat_tool::FrequencyDistribution::ascii_write;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::FrequencyDistribution::*method_pointer_77c38099f1665e368624a3b1a0fdeaf0)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool ) const = &::stat_tool::FrequencyDistribution::spreadsheet_characteristic_print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::FrequencyDistribution::*method_pointer_b738b069f80e5ddfb00f3c74384e9988)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &) const = &::stat_tool::FrequencyDistribution::spreadsheet_circular_characteristic_print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::FrequencyDistribution::*method_pointer_cdfaa12eae3154d7a3b55265b7e2e800)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool , bool ) const = &::stat_tool::FrequencyDistribution::spreadsheet_print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::FrequencyDistribution::*method_pointer_222a2135eb8157e19c940ec1d11d60f5)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &) const = &::stat_tool::FrequencyDistribution::plot_title_print;
    ...
    class ::stat_tool::DiscreteDistributionData * (::stat_tool::FrequencyDistribution::*method_pointer_d9b6451540d05402a84ab9bebe0c7d93)(int , class ::std::vector< class ::stat_tool::FrequencyDistribution, class ::std::allocator< class ::stat_tool::FrequencyDistribution > > ) const = &::stat_tool::FrequencyDistribution::merge;
    ...
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::FrequencyDistribution::*method_pointer_f37ed0d0b42b5aa894702eb85129cbcb)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &) const = &::stat_tool::FrequencyDistribution::survival_ascii_write;
    ...
    class ::stat_tool::DiscreteMixture * (::stat_tool::FrequencyDistribution::*method_pointer_1913722a8c9e5715a45984933ad61dde)(class ::stat_tool::StatError &, int , class ::std::vector< enum ::stat_tool::discrete_parametric, class ::std::allocator< enum ::stat_tool::discrete_parametric > > , int , bool , bool , double ) const = &::stat_tool::FrequencyDistribution::discrete_mixture_estimation;
    ...
    class_f7aa7e5718795bbe854edb6369819dd9.def("ascii_print", method_pointer_fe56e7a238fd57bab9b0d879dad60138, boost::python::return_internal_reference<>(), "");
    class_f7aa7e5718795bbe854edb6369819dd9.def("ascii_write", method_pointer_47742b5d162a572196d7afae32ba3de5, boost::python::return_internal_reference<>(), "");
    class_f7aa7e5718795bbe854edb6369819dd9.def("spreadsheet_characteristic_print", method_pointer_77c38099f1665e368624a3b1a0fdeaf0, boost::python::return_internal_reference<>(), "");
    class_f7aa7e5718795bbe854edb6369819dd9.def("spreadsheet_circular_characteristic_print", method_pointer_b738b069f80e5ddfb00f3c74384e9988, boost::python::return_internal_reference<>(), "");
    class_f7aa7e5718795bbe854edb6369819dd9.def("spreadsheet_print", method_pointer_cdfaa12eae3154d7a3b55265b7e2e800, boost::python::return_internal_reference<>(), "");
    class_f7aa7e5718795bbe854edb6369819dd9.def("plot_title_print", method_pointer_222a2135eb8157e19c940ec1d11d60f5, boost::python::return_internal_reference<>(), "");
    ...
    class_f7aa7e5718795bbe854edb6369819dd9.def("merge", method_pointer_d9b6451540d05402a84ab9bebe0c7d93, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
    ...
    class_f7aa7e5718795bbe854edb6369819dd9.def("survival_ascii_write", method_pointer_f37ed0d0b42b5aa894702eb85129cbcb, boost::python::return_internal_reference<>(), "");
    ...
    class_f7aa7e5718795bbe854edb6369819dd9.def("comparison", method_pointer_8eced7f59e185410b1f0f5718eae4022, "");
    ...
    class_f7aa7e5718795bbe854edb6369819dd9.def("discrete_mixture_estimation", method_pointer_1913722a8c9e5715a45984933ad61dde, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
    ...
    class_f7aa7e5718795bbe854edb6369819dd9.def("discrete_mixture_estimation", method_pointer_ba50901a242b542daadd832b5a79927b, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
