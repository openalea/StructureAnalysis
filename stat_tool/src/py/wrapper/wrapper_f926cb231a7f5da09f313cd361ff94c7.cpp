...
namespace autowig
{
    PyObject* error_f926cb231a7f5da09f313cd361ff94c7 = NULL;

    void translate_f926cb231a7f5da09f313cd361ff94c7(class ::std::exception const & error) { PyErr_SetString(error_f926cb231a7f5da09f313cd361ff94c7, error.what()); };
}
