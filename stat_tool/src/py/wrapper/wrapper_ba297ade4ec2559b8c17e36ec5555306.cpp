...
void wrapper_ba297ade4ec2559b8c17e36ec5555306()
{
    ...
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Distribution::*method_pointer_2ef7682a31b25fa3967b8b84bfc2020a)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool , bool ) const = &::stat_tool::Distribution::ascii_characteristic_print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Distribution::*method_pointer_dc9e75fc535658679e64b994efceb704)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool , bool , bool , class ::stat_tool::FrequencyDistribution const *) const = &::stat_tool::Distribution::ascii_print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Distribution::*method_pointer_3b51780900df5391ba014c6cb7c3dd69)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &) const = &::stat_tool::Distribution::print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Distribution::*method_pointer_fc62e5957d155ce0bb1540b7f70cfaf4)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool ) const = &::stat_tool::Distribution::spreadsheet_characteristic_print;
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Distribution::*method_pointer_7a2fa049fdbf50378a84c364cde99a94)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, bool , bool , bool , class ::stat_tool::FrequencyDistribution const *) const = &::stat_tool::Distribution::spreadsheet_print;
    ...
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Distribution::*method_pointer_8ce3a056decd5a1fba4eb53424486908)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &) const = &::stat_tool::Distribution::plot_title_print;
    ...
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::Distribution::*method_pointer_6a8cabc428e4585bb012df80b54c2f1a)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &) const = &::stat_tool::Distribution::survival_ascii_write;
    bool  (::stat_tool::Distribution::*method_pointer_176c9ae711405300bb559f47fff50423)(class ::stat_tool::StatError &, class ::std::basic_string< char, struct ::std::char_traits< char >, class ::std::allocator< char > > const) const = &::stat_tool::Distribution::survival_ascii_write;
    bool  (::stat_tool::Distribution::*method_pointer_ee73b5a8b1485e08a10e7440d385f9ae)(class ::stat_tool::StatError &, class ::std::basic_string< char, struct ::std::char_traits< char >, class ::std::allocator< char > > const) const = &::stat_tool::Distribution::survival_spreadsheet_write;
    ...
    class_ba297ade4ec2559b8c17e36ec5555306.def("ascii_characteristic_print", method_pointer_2ef7682a31b25fa3967b8b84bfc2020a, boost::python::return_internal_reference<>(), "");
    class_ba297ade4ec2559b8c17e36ec5555306.def("ascii_print", method_pointer_dc9e75fc535658679e64b994efceb704, boost::python::return_internal_reference<>(), "");
    class_ba297ade4ec2559b8c17e36ec5555306.def("print", method_pointer_3b51780900df5391ba014c6cb7c3dd69, boost::python::return_internal_reference<>(), "");
    class_ba297ade4ec2559b8c17e36ec5555306.def("spreadsheet_characteristic_print", method_pointer_fc62e5957d155ce0bb1540b7f70cfaf4, boost::python::return_internal_reference<>(), "");
    class_ba297ade4ec2559b8c17e36ec5555306.def("spreadsheet_print", method_pointer_7a2fa049fdbf50378a84c364cde99a94, boost::python::return_internal_reference<>(), "");
    class_ba297ade4ec2559b8c17e36ec5555306.def("plot_nb_value_computation", method_pointer_bf5ecf127084544b8020df64a53b8af6, "");
    class_ba297ade4ec2559b8c17e36ec5555306.def("plot_title_print", method_pointer_8ce3a056decd5a1fba4eb53424486908, boost::python::return_internal_reference<>(), "");
    ...
    class_ba297ade4ec2559b8c17e36ec5555306.def("survival_ascii_write", method_pointer_6a8cabc428e4585bb012df80b54c2f1a, boost::python::return_internal_reference<>(), "");
    class_ba297ade4ec2559b8c17e36ec5555306.def("survival_ascii_write", method_pointer_176c9ae711405300bb559f47fff50423, "");
    class_ba297ade4ec2559b8c17e36ec5555306.def("survival_spreadsheet_write", method_pointer_ee73b5a8b1485e08a10e7440d385f9ae, "");
