...
void wrapper_4cdf3268c85b531ab98dd99593a41730()
{
    ...
    class ::std::basic_ostream< char, struct ::std::char_traits< char > > & (::stat_tool::StatError::*method_pointer_9a50c46e29225e6482a864d8c627313f)(class ::std::basic_ostream< char, struct ::std::char_traits< char > > &, enum ::stat_tool::error_type ) const = &::stat_tool::StatError::ascii_write;
    ...
    class_4cdf3268c85b531ab98dd99593a41730.def("ascii_write", method_pointer_9a50c46e29225e6482a864d8c627313f, boost::python::return_internal_reference<>(), "");
