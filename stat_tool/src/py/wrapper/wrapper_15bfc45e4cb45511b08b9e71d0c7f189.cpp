...
void wrapper_15bfc45e4cb45511b08b9e71d0c7f189()
{
    ...
    class_15bfc45e4cb45511b08b9e71d0c7f189.def(boost::python::init<  >(""));
    class_15bfc45e4cb45511b08b9e71d0c7f189.def(boost::python::init< struct ::std::pair< float, float > const &, class ::std::basic_string< char, struct ::std::char_traits< char >, class ::std::allocator< char > > const & >(""));
    class_15bfc45e4cb45511b08b9e71d0c7f189.def(boost::python::init< struct ::std::pair< struct ::std::pair< float, float >, class ::std::basic_string< char, struct ::std::char_traits< char >, class ::std::allocator< char > > > const & >(""));
    class_15bfc45e4cb45511b08b9e71d0c7f189.def("swap", method_pointer_3bd26b43d42756fbb1ab5f4f3e3cbdad, "");
    class_15bfc45e4cb45511b08b9e71d0c7f189.def_readwrite("first", &::std::pair< struct ::std::pair< float, float >, class ::std::basic_string< char, struct ::std::char_traits< char >, class ::std::allocator< char > > >::first, "");
    class_15bfc45e4cb45511b08b9e71d0c7f189.def_readwrite("second", &::std::pair< struct ::std::pair< float, float >, class ::std::basic_string< char, struct ::std::char_traits< char >, class ::std::allocator< char > > >::second, "");
