...
void wrapper_9839f8684cb95ec091ee7dde51a7e147()
{
    ...
    class ::stat_tool::DiscreteMixture * (*method_pointer_a7122488c11a5828be53e0f6358ce7ef)(class ::stat_tool::StatError &, int , class ::std::vector< double, class ::std::allocator< double > > , class ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > > const) = ::stat_tool::DiscreteMixture::building;
    class ::stat_tool::DiscreteMixture * (*method_pointer_de1b6e78e8155af29974fe90af65ae62)(class ::stat_tool::StatError &, class ::std::basic_string< char, struct ::std::char_traits< char >, class ::std::allocator< char > > const, double ) = ::stat_tool::DiscreteMixture::ascii_read;
    ...
    class_9839f8684cb95ec091ee7dde51a7e147.def(boost::python::init< int , class ::std::vector< double, class ::std::allocator< double > > , class ::std::vector< class ::stat_tool::DiscreteParametric, class ::std::allocator< class ::stat_tool::DiscreteParametric > > const >(""));
    ...
    class_9839f8684cb95ec091ee7dde51a7e147.def("building", method_pointer_a7122488c11a5828be53e0f6358ce7ef, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
    class_9839f8684cb95ec091ee7dde51a7e147.def("ascii_read", method_pointer_de1b6e78e8155af29974fe90af65ae62, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
    ...
    class_9839f8684cb95ec091ee7dde51a7e147.staticmethod("building");
    ...
    if(autowig::Held< class ::stat_tool::DiscreteMixture >::is_class)
    {
        ...
        //boost::python::objects::class_value_wrapper< autowig::Held< class ::stat_tool::DiscreteMixture >::Type, boost::python::objects::make_ptr_instance< class ::stat_tool::DiscreteMixture, boost::python::objects::pointer_holder< autowig::Held< class ::stat_tool::DiscreteMixture >::Type, class ::stat_tool::DiscreteMixture > > >();
    }
