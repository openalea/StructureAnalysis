...
const int MIXTURE_NB_COMPONENT = 10;   // nombre maximum de composantes
...
class Mixture : public STAT_interface , protected Distribution {  // melange de lois discretes parametriques
...
class Mixture_data : public STAT_interface , protected Histogram {  // structure de donnees correspondant
                                                                    // a un melange
    friend class Histogram;
