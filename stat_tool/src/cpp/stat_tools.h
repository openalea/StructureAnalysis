...
/*    friend class Distribution;
    ...
    friend std::ostream& dissimilarity_ascii_write(std::ostream &os , int nb_histo , const Histogram **histo ,
                                                   int type , double **dissimilarity);
    friend bool dissimilarity_ascii_write(Format_error &error , const char *path , int nb_histo ,
                                          const Histogram **histo , int type , double **dissimilarity);
    friend bool dissimilarity_spreadsheet_write(Format_error &error , const char *path , int nb_histo ,
                                                const Histogram **histo , int type , double **dissimilarity);
