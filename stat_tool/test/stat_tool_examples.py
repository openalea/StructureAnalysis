...
convol2 = Estimate(
    convol_histo1, "CONVOLUTION", ExtractDistribution(convol1, 1), MinInfBound=0
)
...
convol30 = Estimate(
    Shift(histo_s2, 1), "CONVOLUTION", Estimate(histo_b2, "NP"), NbIteration=500
)
convol31 = Estimate(
    Shift(histo_s2, 1),
    "CONVOLUTION",
...
convol32 = Estimate(
    Shift(histo_s2, 1), "CONVOLUTION", Estimate(histo_b2, "NP"), Estimator="Parametric"
)
# Display(convol31)
Plot(convol31)
...
cdist2 = Estimate(
    chisto1, "COMPOUND", ExtractDistribution(cdist1, "Elementary"), "Sum", MinInfBound=0
)
...
cdist3 = Estimate(
    histo34, "COMPOUND", Distribution("B", 0, 1, 0.7), "Sum", MinInfBound=0
)
