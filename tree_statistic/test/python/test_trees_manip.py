...
try:
    T.Cluster("Limit", 1, list(range(12)))
except trees.StatTreeError as e:
    print(e)
else:
...
try:
    V = T.Transcode(1, list(range(0, 5)) + list(range(6,13)))
except trees.StatTreeError as e:
    print(e)
else:
...
try:
    T.Transcode(1, list(range(0,10))+ [T])
except TypeError as e:
    print(e)
else:
    print("Failed to raise exception for incorrect symbol type.")
try:
    T.Transcode( -1, list(range(0, 11)))
except IndexError as e:
    print(e)
else:
    "Failed to raise exception for bad variable index."
