...
struct Parametric_Wrapper: Parametric
{
    ...
    Parametric_Wrapper(PyObject* self_, const Length_bias& p0):
        Parametric(p0), self(self_) {}

    Parametric_Wrapper(PyObject* self_, const Histogram& p0):
        Parametric(p0), self(self_) {}
...
/*    class_< Parametric_model, bases< Parametric > ,
    ("Parametricm", init< const Histogram& >() )
        .def(init< const Distribution& >())
