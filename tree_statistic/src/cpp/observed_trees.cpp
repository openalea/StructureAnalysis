 ...
 *
 *       $Source$
 *       $Id: observed_trees.cpp 3193 2007-05-29 10:03:19Z dufourko $
 *
...
#include "SEQUENCE/sequences.h" // definition of constants

#include "int_fl_containers.h"
#include "generic_tree.h"
#include "observed_trees.h"
#include <iostream>
#include <cstdlib>
...
void Tree_characteristics::build_marginal_histogram(One_int_tree* otrees1)
{ // marginal histogram
...
void Tree_characteristics::build_first_occurrence_root_histogram(One_int_tree* otrees1,
                                                                 int imax_depth)
{ //  histogram of first occurrence (root)

   typedef One_int_tree::vertex_iterator vertex_iterator;
   typedef One_int_tree::vertex_array vertex_array;

   int t, v, curr_val, nb_values= _max_value - _min_value + 1;
   int size, index;
   vertex_array va;
   generic_visitor<One_int_tree> visitor;
   bool *occurrence;
...
void Tree_characteristics::build_first_occurrence_leaves_histogram(One_int_tree* otrees1,
                                                                   int imax_depth)
...
void Tree_characteristics::build_zone_histograms(One_int_tree* otrees1,
                                                 int imax_size)
{ //  histogram of homogeneous zones

   typedef One_int_tree::children_iterator children_iterator;
   typedef One_int_tree::key key;
...
void Tree_characteristics::build_nb_occurrences_histogram(One_int_tree* otrees1,
                                                          int imax_size)
{
   typedef One_int_tree::vertex_iterator vertex_iterator;
