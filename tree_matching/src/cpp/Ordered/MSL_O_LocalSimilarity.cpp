...
//------------------------------------------------------------------------
DistanceType MSL_O_Similarity::insLocalNode(TreeGraph* T, int w){
  DistanceType Dist;
...
//------------------------------------------------------------------------
DistanceType MSL_O_Similarity::delLocalNode(TreeGraph* T, int v){
  DistanceType Dist;
...
//------------------------------------------------------------------------
DistanceType MSL_O_Similarity::matchLocalNode(int v, int w){
  DistanceType Dist;
