...
#include "matching3.h"
  ...
  // Constructeur
  // -------------
MatchingByComponents::MatchingByComponents(TreeGraph& input,TreeGraph& reference,NodeCost& nodeDistance)
{
  T1=&input;
  T2=&reference;
  ND=&nodeDistance;
...
// constante qui va permettre de calculer l'alignement restreint
  ...
  // Destructeur
  // -------------
MatchingByComponents::~MatchingByComponents()
{
}
  ...
  // ----------------------------------------------------------------------------------
DistanceType MatchingByComponents::distanceBetweenTree(int input_vertex,int reference_vertex)
{
...
// forets
// -------------------------------
DistanceType MatchingByComponents::distanceBetweenForest(int input_vertex,int reference_vertex)
{
...
DistanceType MatchingByComponents::match()
{
  DistanceType D=0;
...
int MatchingByComponents::getNBC(int input_vertex,int reference_vertex) const
{
  return(_nbInputTreeConnectedComponents.getNBC(input_vertex,reference_vertex));
}

int MatchingByComponents::getNBCRef(int input_vertex,int reference_vertex) const
{
