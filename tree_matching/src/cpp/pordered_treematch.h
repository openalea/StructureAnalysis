...
#ifndef SB_PORDERED_TREE_MATCH_HEADER
#define SB_PORDERED_TREE_MATCH_HEADER

#include "definitions.h"

/* Déclaration des differents matching */
#include "POrdered/matching_PO.h"
#include "POrdered/matching_PO_end_space.h"
#include "POrdered/matching_PO_local.h"
...
class TreeMatch_PO : public TreeMatch
{
  public :

  TreeMatch_PO();

  TreeMatch_PO( MTG& mtg, Array* roots);

  TreeMatch_PO( MTG& mtg,
	       Array* roots,
