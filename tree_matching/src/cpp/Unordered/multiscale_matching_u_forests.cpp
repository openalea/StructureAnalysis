...
DistanceType MultiscaleMatching_U::distanceBetweenForest_v_l(int input_vertex,int reference_vertex) 
{
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_l_w(int input_vertex,int reference_vertex) 
{
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
  DistanceType cost1,cost2,cost3;
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_v_w_v_l(int input_vertex,int reference_vertex) 
{
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
  DistanceType cost1,cost2,cost3;
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_v_w_l_w(int input_vertex,int reference_vertex) 
{
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
  DistanceType cost1,cost2,cost3;
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_v_w_(int input_vertex,int reference_vertex) 
{
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
  DistanceType cost1,cost2,cost3;
  ...
  IntVectorTable choice_v_w = IntVectorTable(ni+1);
  choice_v_w[0].resize(nj+1);
  
  for (int s1=1;s1<=ni;s1++) {
    input_list->push_back(T1->child(input_vertex,s1));
  	choice_v_w[s1].resize(nj+1);
  }
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_v_w_v_w(int input_vertex,int reference_vertex) 
{
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
  DistanceType cost1,cost2,cost3;
  ...
  IntVectorTable choice = IntVectorTable(ni+1);
  choice[0].resize(nj+1);
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_l_l_v_l(int input_vertex,int reference_vertex) 
{
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
  DistanceType cost1,cost2,cost3;
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_l_l_l_w(int input_vertex,int reference_vertex) 
{
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
  DistanceType cost1,cost2,cost3;
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_l_l_l_l(int input_vertex,int reference_vertex) 
{
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
  DistanceType cost1,cost2,cost3;
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_l_l_v_w(int input_vertex,int reference_vertex) 
{
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
  DistanceType cost1,cost2,cost3;
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_l_l(int input_vertex,int reference_vertex)
{
...
DistanceType MultiscaleMatching_U::distanceBetweenForest_v_w(int input_vertex,int reference_vertex)
{
...
DistanceType MultiscaleMatching_U::distanceBetweenForest(int input_vertex,int reference_vertex)
{
