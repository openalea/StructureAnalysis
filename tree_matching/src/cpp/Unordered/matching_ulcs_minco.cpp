...
#include "matching_ulcs_minco.h"

  // -------------
  // Constructeur
  // -------------
Matching_U_LargestCommonSubTree_Using_MinimumComponents::Matching_U_LargestCommonSubTree_Using_MinimumComponents(TreeGraph& input,TreeGraph& reference,NodeCost& nodeDistance)
{
  Matching_U_MinCo( *T1,*T2,*ND);
...
// constante qui va permettre de calculer l'alignement restreint
  ...
  // Destructeur
  // -------------
Matching_U_LargestCommonSubTree_Using_MinimumComponents::~Matching_U_LargestCommonSubTree_Using_MinimumComponents()
{
}
  ...
  // ----------------------------------------------------------------------------------
DistanceType Matching_U_LargestCommonSubTree_Using_MinimumComponents::distanceBetweenTree(int input_vertex,int reference_vertex)
{
...
// forets
// -------------------------------
DistanceType Matching_U_LargestCommonSubTree_Using_MinimumComponents::distanceBetweenForest(int input_vertex,int reference_vertex)
{
...
DistanceType Matching_U_LargestCommonSubTree_Using_MinimumComponents::match()
{
  DistanceType D=0;
...
int Matching_U_LargestCommonSubTree_Using_MinimumComponents::getNBC(int input_vertex,int reference_vertex) const
{
  return(_nbInputConnectedComponents.getNBC(input_vertex,reference_vertex));
}

int Matching_U_LargestCommonSubTree_Using_MinimumComponents::getNBCRef(int input_vertex,int reference_vertex) const
{
...
int Matching_U_LargestCommonSubTree_Using_MinimumComponents::getNBCT1(int input_vertex,int reference_vertex) const
{
  return(_nbInputConnectedComponentsT1.getNBC(input_vertex,reference_vertex));
}

int Matching_U_LargestCommonSubTree_Using_MinimumComponents::getNBCRefT2(int input_vertex,int reference_vertex) const
{
