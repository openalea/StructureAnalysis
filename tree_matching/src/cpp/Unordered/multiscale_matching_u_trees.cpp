#include "multiscale_matching_u.h"
  ...
  // Constructeur
  // -------------
MultiscaleMatching_U::MultiscaleMatching_U(TreeGraph& input,TreeGraph& reference,NodeCost& nodeDistance)
{
  T1=&input;
  T2=&reference;
  ND=&nodeDistance;
...
// Destructeur
  // -------------
MultiscaleMatching_U::~MultiscaleMatching_U()
{
}
...
// ----------------------------------------------------------------------------------
DistanceType MultiscaleMatching_U::distanceBetweenTree_v_l(int input_vertex,int reference_vertex)
{
...
// ----------------------------------------------------------------------------------
DistanceType MultiscaleMatching_U::distanceBetweenTree_l_w(int input_vertex,int reference_vertex)
{
  // On stocke dans ni et nj le nombre d'enfants de T1[i] et T2[j]
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
...
// quand pi(v) n'a pas d'image et pi(w) a une image
// ----------------------------------------------------------------------------------
DistanceType MultiscaleMatching_U::distanceBetweenTree_v_w_v_l(int input_vertex,int reference_vertex)
{
  // On stocke dans ni et nj le nombre d'enfants de T1[i] et T2[j]
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
...
DistanceType MultiscaleMatching_U::distanceBetweenTree_v_w_l_w(int input_vertex,int reference_vertex)
{
  // On stocke dans ni et nj le nombre d'enfants de T1[i] et T2[j]
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
...
DistanceType MultiscaleMatching_U::distanceBetweenTree_v_w_v_w(int input_vertex,int reference_vertex)
{
  // On stocke dans ni et nj le nombre d'enfants de T1[i] et T2[j]
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
...
DistanceType MultiscaleMatching_U::distanceBetweenTree_v_w_(int input_vertex,int reference_vertex)
{
  // On stocke dans ni et nj le nombre d'enfants de T1[i] et T2[j]
  int ni=T1->getNbChild(input_vertex);
  int nj=T2->getNbChild(reference_vertex);
...
DistanceType MultiscaleMatching_U::distanceBetweenTree_l_l_v_l(int input_vertex,int reference_vertex)
{
...
DistanceType MultiscaleMatching_U::distanceBetweenTree_l_l_l_w(int input_vertex,int reference_vertex)
{
...
DistanceType MultiscaleMatching_U::distanceBetweenTree_l_l_v_w(int input_vertex,int reference_vertex)
{
...
DistanceType MultiscaleMatching_U::distanceBetweenTree_l_l_l_l(int input_vertex,int reference_vertex)
{
...
DistanceType MultiscaleMatching_U::distanceBetweenTree_l_l(int input_vertex,int reference_vertex)
{
...
DistanceType MultiscaleMatching_U::distanceBetweenTree_v_w(int input_vertex,int reference_vertex)
{
...
DistanceType MultiscaleMatching_U::distanceBetweenTree(int input_vertex,int reference_vertex)
{
