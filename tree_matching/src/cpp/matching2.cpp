...
#include "matching2.h"
  ...
  // Constructeur
  // -------------
MatchingWithTwoComponents::MatchingWithTwoComponents(TreeGraph& input,TreeGraph& reference,NodeCost& nodeDistance)
{
  T1=&input;
  T2=&reference;
  ND=&nodeDistance;
...
// constante qui va permettre de calculer l'alignement restreint
  _restrMapp.link(I_MAX(T1->getDegree(),T2->getDegree()),*_modifiedDistances.getDistanceTable());
}
  // -------------
  // Destructeur
  // -------------
MatchingWithTwoComponents::~MatchingWithTwoComponents()
{
}
  ...
  // ----------------------------------------------------------------------------------
DistanceType MatchingWithTwoComponents::distanceBetweenTree(int input_vertex,int reference_vertex)
{
...
// forets
// -------------------------------
DistanceType MatchingWithTwoComponents::distanceBetweenForest(int input_vertex,int reference_vertex)
{
...
DistanceType MatchingWithTwoComponents::match()
{
  DistanceType D=0;
...
int MatchingWithTwoComponents::getNBC(int input_vertex,int reference_vertex) const
{
  return(_nbInputTreeConnectedComponents.getNBC(input_vertex,reference_vertex));
}

int MatchingWithTwoComponents::getNBCRef(int input_vertex,int reference_vertex) const
{
