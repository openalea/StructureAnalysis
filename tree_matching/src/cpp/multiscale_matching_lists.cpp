...
void MultiscaleMatching::getList(int input_vertex, int reference_vertex, Sequence* sequence) 
{
...
void MultiscaleMatching::ForestList(int input_vertex,int reference_vertex,Sequence& sequence) 
{
...
DistanceType MultiscaleMatching::match() 
{
...
// --------------------------------------------
DistanceType MultiscaleMatching::getDBT(int input_vertex,int reference_vertex) const
{
  return(_d.getDBT(input_vertex,reference_vertex));
}

DistanceType MultiscaleMatching::getDBF(int input_vertex,int reference_vertex) const
{
...
int MultiscaleMatching::M(int i_node,int r_node)
{
  return(_choices.getList(i_node,r_node)->back());
}		

// renvoie
int MultiscaleMatching::M_v_l(int i_node,int r_node) 
{
  return(_choices_v_l.getList(i_node,r_node)->back());
}		

int MultiscaleMatching::M_v_w(int i_node,int r_node)
{
  return(_choices_v_w.getList(i_node,r_node)->back());
}		
int MultiscaleMatching::M_v_w_v_w(int i_node,int r_node)
{
  return(_choices_v_w_v_w.getList(i_node,r_node)->back());
}		
int MultiscaleMatching::M_v_w_v_l(int i_node,int r_node)
{
  return(_choices_v_w_v_l.getList(i_node,r_node)->back());
}		
int MultiscaleMatching::M_v_w_l_w(int i_node,int r_node)
{
  return(_choices_v_w_l_w.getList(i_node,r_node)->back());
}		
int MultiscaleMatching::M_v_w_(int i_node,int r_node)
{
  return(_choices_v_w_.getList(i_node,r_node)->back());
}		

int MultiscaleMatching::M_l_w(int i_node,int r_node)
{
  return(_choices_l_w.getList(i_node,r_node)->back());
}		

int MultiscaleMatching::M_l_l(int i_node,int r_node)
{
  return(_choices_l_l.getList(i_node,r_node)->back());
}		
int MultiscaleMatching::M_l_l_v_w(int i_node,int r_node)
{
  return(_choices_l_l_v_w.getList(i_node,r_node)->back());
}		
int MultiscaleMatching::M_l_l_v_l(int i_node,int r_node)
{
  return(_choices_l_l_v_l.getList(i_node,r_node)->back());
}		
int MultiscaleMatching::M_l_l_l_w(int i_node,int r_node)
{
  return(_choices_l_l_l_w.getList(i_node,r_node)->back());
}		
int MultiscaleMatching::M_l_l_l_l(int i_node,int r_node)
{
  return(_choices_l_l_l_l.getList(i_node,r_node)->back());
}		

void MultiscaleMatching::TreeList(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_v_l(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_l_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_v_w_v_l(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_v_w_l_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_v_w_v_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_v_w_(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_l_l_v_l(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_l_l_l_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_l_l_v_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_l_l_l_l(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_v_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::TreeList_l_l(int input_vertex,int reference_vertex,Sequence& sequence)
{
  if ((!T1->isNull())&&(!T2->isNull()))
    {
      ChoiceList* L=_choices.getList(input_vertex,reference_vertex);
...
void MultiscaleMatching::ForestList_v_l(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::ForestList_l_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::ForestList_v_w_v_l(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::ForestList_v_w_l_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::ForestList_v_w_(int input_vertex,int reference_vertex,Sequence& sequence)
{
  ChoiceList* L=_choices_v_w_.getList(input_vertex,reference_vertex);
  int forest_choice=Lat(L,2);
...
void MultiscaleMatching::ForestList_v_w_v_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
  ChoiceList* L=_choices_v_w_v_w.getList(input_vertex,reference_vertex);
  int forest_choice=Lat(L,2);
...
void MultiscaleMatching::ForestList_v_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
  ChoiceList* L=_choices_v_w.getList(input_vertex,reference_vertex);
  int forest_choice=Lat(L,2);
...
void MultiscaleMatching::ForestList_l_l_v_l(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::ForestList_l_l_l_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::ForestList_l_l_l_l(int input_vertex,int reference_vertex,Sequence& sequence)
{
...
void MultiscaleMatching::ForestList_l_l_v_w(int input_vertex,int reference_vertex,Sequence& sequence)
{
  ChoiceList* L=_choices_l_l_v_w.getList(input_vertex,reference_vertex);
  int forest_choice=Lat(L,2);
