...
#ifndef SB_MATCHING2_HEADER
#define SB_MATCHING2_HEADER
...
/**
 *\class Matching With Two Components
...
class MatchingWithTwoComponents : public Matching
{
	
  public :
    MatchingWithTwoComponents(TreeGraph& , TreeGraph& ,NodeCost& ) ;
    void make(TreeGraph& , TreeGraph& ,NodeCost& ) ;
    //Destructor
    ~MatchingWithTwoComponents();
