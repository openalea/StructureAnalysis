...
//------------------------------------------------------------------------------------------------------
ostream& TreeMatch_O::viewAllMatching(ostream& out_fich) const
{
  char TAB='\t';
  out_fich<<TAB;
...
Distance_matrix* TreeMatch_O::getMatrix()
{
  int nb_tree ;
...
// DISPLAY THE RESULTS OF THE MATCHING
//------------------------------------------------------------------------------------------------------
ostream& TreeMatch_O::introduce(ostream& out_info) const
{
...
//------------------------------------------------------------------------------------------------------
SLArray* TreeMatch_O::getList(int i_tree,int r_tree)
{
...
// RETURN A DISTANCE
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_O::getDist(int i_tree,int r_tree)
{
...
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_O::getTime(int inp_tree,int ref_tree) const
{
...
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_O::getNormalizedDistance(int i_tree,int r_tree)
{
...
// RETURN A NORMALIZED DISTANCE
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_O::getSelfSimilarNormalizedDistance(int i_tree,int r_tree)
{
...
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_O::getSelfSimilarDistance(int i_tree,int r_tree) const
{
...
DistanceType TreeMatch_O::getC(ostream& out_info,int i_tree,int r_tree) const
{
...
// DISPLAY THE RESULTS OF THE MATCHING
//------------------------------------------------------------------------------------------------------
ostream& TreeMatch_O::viewOneMatching(ostream& out_info,int imp_tree,int ref_tree) const
{
  char TAB='\t';
  int i=0,j=0,k=0;
...
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_O::viewDistanceMatching(ostream& out_info,int inp_tree,int ref_tree) const
{
  if (inp_tree == ref_tree)
    {
      //out_info<<0.<<endl;
...
DistanceType TreeMatch_O::viewNormalizedDistance(ostream& out_info,int i_tree,int r_tree)
{
  if (i_tree == r_tree)
    {
      return ( 0.);
...
int TreeMatch_O::viewVertex(int i_tree)
{
...
void TreeMatch_O::putDistance(DistanceType distance,int inp_tree,int ref_tree)
{
  if (inp_tree>ref_tree)
    {
...
void TreeMatch_O::putTime(DistanceType time,int inp_tree,int ref_tree)
{
  if (inp_tree>ref_tree)
    {
...
void TreeMatch_O::putDistanceMatrix(MatchingDistanceTable matrix)
{
...
DistanceType TreeMatch_O::getDistance(int inp_tree,int ref_tree) const
{
  if (inp_tree==ref_tree) return(0.0);
...
void TreeMatch_O::putSequence(Sequence* sequence,int inp_tree,int ref_tree)
{
  if (inp_tree>ref_tree)
    {
...
void TreeMatch_O::putSequenceTab(Sequence*** sequence_tab,int inp_tree,int ref_tree)
{
  if (inp_tree>ref_tree)
    {
...
Sequence* TreeMatch_O::getSequence(int inp_tree,int ref_tree) const
{
  if (inp_tree>ref_tree)
    {
...
Sequence*** TreeMatch_O::getSequenceTab(int inp_tree,int ref_tree) const
{
  if (inp_tree>ref_tree)
    {
...
TreeGraph* TreeMatch_O::getTree(int tree) const
{
  return(_trees[tree]);
}

int  TreeMatch_O::getNbTree() const
{
  return(_nbTree);
}

MatchingType TreeMatch_O::getMatchingType() const
{
...
int  TreeMatch_O::getMaxOrder() const
{
  return(_maxOrder);
}

int  TreeMatch_O::getNbVertexMax() const
{
  return(_maxNbVertex);
}
...
bool TreeMatch_O::mtg_write( const char *path ) const
{
