...
#ifndef SB_UNORDERED_TREE_MATCH_HEADER
#define SB_UNORDERED_TREE_MATCH_HEADER

#include "definitions.h"

/* Déclaration des differents matching */
#include "Unordered/matching_unordered.h"
#include "Unordered/local_matching_u.h"
#include "Unordered/matching_ulcs.h"
#include "Unordered/matching_uminco.h"
#include "Unordered/multiscale_matching_u.h"
#include "Unordered/end_space_free_matching_u.h"
...
class TreeMatch_U : public TreeMatch
{
  public :

  TreeMatch_U();

  TreeMatch_U( MTG& mtg, Array* roots);
