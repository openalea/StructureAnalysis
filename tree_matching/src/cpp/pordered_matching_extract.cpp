...
//------------------------------------------------------------------------------------------------------
ostream& TreeMatch_PO::viewAllMatching(ostream& out_fich) const
{
  char TAB='\t';
  out_fich<<TAB;
...
// DISPLAY THE RESULTS OF THE MATCHING
//------------------------------------------------------------------------------------------------------
ostream& TreeMatch_PO::introduce(ostream& out_info) const
{
...
//------------------------------------------------------------------------------------------------------
SLArray* TreeMatch_PO::getList(int i_tree,int r_tree)
{
...
// RETURN A DISTANCE
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_PO::getDist(int i_tree,int r_tree)
{
...
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_PO::getTime(int inp_tree,int ref_tree) const
{
...
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_PO::getNormalizedDistance(int i_tree,int r_tree)
{
...
// RETURN A NORMALIZED DISTANCE
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_PO::getSelfSimilarNormalizedDistance(int i_tree,int r_tree)
{
...
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_PO::getSelfSimilarDistance(int i_tree,int r_tree) const
{
...
DistanceType TreeMatch_PO::getC(ostream& out_info,int i_tree,int r_tree) const
{
...
// DISPLAY THE RESULTS OF THE MATCHING
//------------------------------------------------------------------------------------------------------
ostream& TreeMatch_PO::viewOneMatching(ostream& out_info,int imp_tree,int ref_tree) const
{
  char TAB='\t';
  int i=0,j=0,k=0;
...
//------------------------------------------------------------------------------------------------------
DistanceType TreeMatch_PO::viewDistanceMatching(ostream& out_info,int inp_tree,int ref_tree) const
{
  if (inp_tree == ref_tree)
    {
      //out_info<<0.<<endl;
...
DistanceType TreeMatch_PO::viewNormalizedDistance(ostream& out_info,int i_tree,int r_tree)
{
  if (i_tree == r_tree)
    {
      return ( 0.);
...
int TreeMatch_PO::viewVertex(int i_tree)
{
...
void TreeMatch_PO::putDistance(DistanceType distance,int inp_tree,int ref_tree)
{
  if (inp_tree>ref_tree)
    {
...
void TreeMatch_PO::putTime(DistanceType time,int inp_tree,int ref_tree)
{
  if (inp_tree>ref_tree)
    {
...
void TreeMatch_PO::putDistanceMatrix(MatchingDistanceTable matrix)
{
...
DistanceType TreeMatch_PO::getDistance(int inp_tree,int ref_tree) const
{
  if (inp_tree==ref_tree) return(0.0);
...
void TreeMatch_PO::putSequence(Sequence* sequence,int inp_tree,int ref_tree)
{
  if (inp_tree>ref_tree)
    {
...
void TreeMatch_PO::putSequenceTab(Sequence*** sequence_tab,int inp_tree,int ref_tree)
{
  if (inp_tree>ref_tree)
    {
...
Sequence* TreeMatch_PO::getSequence(int inp_tree,int ref_tree) const
{
  if (inp_tree>ref_tree)
    {
...
Sequence*** TreeMatch_PO::getSequenceTab(int inp_tree,int ref_tree) const
{
  if (inp_tree>ref_tree)
    {
...
TreeGraph* TreeMatch_PO::getTree(int tree) const
{
  return(_trees[tree]);
}

int  TreeMatch_PO::getNbTree() const
{
  return(_nbTree);
}

MatchingType TreeMatch_PO::getMatchingType() const
{
...
int  TreeMatch_PO::getMaxOrder() const
{
  return(_maxOrder);
}

int  TreeMatch_PO::getNbVertexMax() const
{
  return(_maxNbVertex);
}
...
bool TreeMatch_PO::mtg_write( const char *path ) const
{
